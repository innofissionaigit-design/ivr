...
# Bengali and English aliases for departments to handle short forms like "ortho"
DEPARTMENT_ALIASES = {
    "General Medicine": ["জেনারেল মেডিসিন", "জেনারেল", "medicine", "general"],
    "Cardiology": ["কার্ডিওলজি", "হার্ট", "heart", "cardio", "cardiology"],
    "Gynaecology & Obstetrics": ["গাইনি", "gyne", "gynaecology", "obstetrics", "women"],
    "Orthopaedics": ["অর্থোপেডিক্স", "অর্থো", "ortho", "orthopedics", "bone", "bones"],
    "ENT": ["ইএনটি", "ent", "ear", "nose", "throat"],
    "Dermatology": ["ডার্মাটোলজি", "স্কিন", "skin", "derma", "dermatology"],
    "Paediatrics": ["পিডিয়াট্রিক্স", "শিশু", "child", "children", "paedia", "pediatrics"],
    "Diabetology & Endocrinology": ["ডায়াবেটোলজি", "সুগার", "diabetes", "sugar", "endo", "endocrinology"],
}
...
LAB_TESTS = [
    ...
    ("Lipid Profile", ["লিপিড প্রোফাইল", "কোলেস্টেরল টেস্ট"], 670.17, "Blood", 24),
    ...
    ("Vitamin B12", ["ভিটামিন বি১২", "বি১২"], 1249.00, "Blood", 48),
    ...
    ("ECG", ["ইসিজি", "ইলেক্ট্রোকার্ডিওগ্রাম"], 355.50, "Cardiac", 1),
    ...
    ("Pap Smear", ["প্যাপ স্মিয়ার"], 989.10, "Sample (Cervical)", 72),
...
def seed():
    ...
    try:
        ...
        for dept_name, doctors in DEPARTMENTS.items():
            aliases = "|".join(DEPARTMENT_ALIASES.get(dept_name, []))
            dept = Department(name=dept_name, aliases_bn=aliases)
            db.add(dept)
